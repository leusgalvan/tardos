...
void test_create_empty_list() {
    doubly_linked_list *l = dll_create();
...
void test_pop_empty_list() {
    doubly_linked_list *l = dll_create();
    dll_pop(l);
    _assert(1, "Popping from empty list yields undefined value");
}
...
void test_concat() {
    ...
    doubly_linked_list *l2 = dll_create();
...
void test_remove_found_1_item() {
    ...
    dll_push(l, 5);
    dll_remove(l, 5);
    _assert(dll_size(l) == 0, 
            "Removing the only element from a list leaves it empty");
}
